...
carParams.weight_dist = 0.5; % percentage of weight in rear
...
carParams.R_sf = 0.5; % proportion of roll stiffness in front (not same as LLTD)
carParams.I_zz = 83.28; %kg-m^2

% aero parameters (updated 5/25/19)
aeroParams = struct();
aeroParams.cda = 0; %1.73; % m^2
