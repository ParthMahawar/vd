...
%   parameters
    ...
    eP.shift_time,DTp.final_drive,DTp.drivetrain_efficiency,DTp.G_d1,DTp.G_d2_overrun,DTp.G_d2_driving,Bp.brake_distribution,Bp.max_braking_torque,tP.gamma,tP.p_i);
...
for i = 1:numel(mass)
    ...
    tire = Tire2(gamma(i),p_i(i),tP.Fx_parameters,tP.Fy_parameters); 
