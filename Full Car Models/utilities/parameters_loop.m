...
%   parameters
    ...
    roll_center_height_front,roll_center_height_rear,R_sf,I_zz,cda,cla,distribution,redline,shift_point,shift_time,...
    final_drive,drivetrain_efficiency,G_d1,G_d2_overrun,G_d2_driving,brake_distribution,max_braking_torque,gamma,p_i,ackermann, camber_compliance]...
    ...
    cP.roll_center_height_front,cP.roll_center_height_rear,cP.R_sf,cP.I_zz,aP.cda,aP.cla,aP.distribution,eP.redline,eP.shift_point,...
    eP.shift_time,DTp.final_drive,DTp.drivetrain_efficiency,DTp.G_d1,DTp.G_d2_overrun,DTp.G_d2_driving,Bp.brake_distribution,...
    Bp.max_braking_torque,tP.gamma,tP.p_i,cP.ackermann,cP.camber_compliance);%tP.friction_scaling_factor);
...
for i = 1:numel(mass)
    ...
    car = Car(mass(i)+driver_weight(i),wheelbase(i),weight_dist(i),track_width(i),wheel_radius(i),...
        cg_height(i),roll_center_height_front(i),roll_center_height_rear(i),R_sf(i),I_zz(i),gamma(i),camber_compliance(i),aero,...
        powertrain,tire,ackermann(i)); 
    accel_car = Car(mass(i)+accel_driver_weight(i),wheelbase(i),weight_dist(i),track_width(i),...
        ...
        I_zz(i),gamma(i),camber_compliance(i),aero,powertrain,tire,ackermann(i)); 
    car_cell{i,1} = car;
