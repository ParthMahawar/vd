...
load('SteeringEffortCalibration3.mat');
...
for i = 1:numel(data)
    ...
    % filter data
    d = fdesign.lowpass('Fp,Fst,Ap,Ast',1,2,0.001,50,Fs);
...
%% Save data
save('SteeringEffortCalibration3_processed.mat','engine_rpm','lat_accel','long_accel',...
    'wheelspeed_FL',...
    'wheelspeed_FR','wheelspeed_RL','yaw_rate','steer_angle','steering_voltage','time');
