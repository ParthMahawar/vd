...
data = {Engine_RPM,G_Force_Lat,G_Force_Long,GP_Volts_5,GP_Volts_6,...
    ...
    Gyro_Yaw_Velocity,Steering_Angle,Drive_Speed_Left};
...
for i = 1:numel(data)
    ...
    % filter data
    d = fdesign.lowpass('Fp,Fst,Ap,Ast',0.5,1,0.001,50,Fs);
...
shockpot_FR = data_resampled{4}.Data;
shockpot_RR = data_resampled{5}.Data;
shockpot_RL = data_resampled{6}.Data;
shockpot_FL = data_resampled{7}.Data;
wheelspeed_FL = data_resampled{8}.Data;
wheelspeed_FR = data_resampled{9}.Data;
yaw_rate = data_resampled{10}.Data;
steer_angle = data_resampled{11}.Data;
...
shockpot_position_FL = shockpot_FL/8;
shockpot_position_FR = shockpot_FR/5;
shockpot_position_RL = shockpot_RL/5;
shockpot_position_RR = shockpot_RR/5;
