...
load('TemperatureCompensated_Fy_pure_parameters_1654run24_3.mat')
%load('Fy_pure_parameters_run16.mat')
parameters{1} = Xbestcell;
load('TemperatureCompensated_Fy_pure_parameters_1965run6.mat')
...
scatter(SA_out,FY_out,'DisplayName','18 RB25 raw data');
title('18x7.5-10 R25B')

%% 
load('TemperatureCompensated_16R25B.mat')

scatter(SA_out,FY_out,'DisplayName','16 RB25 raw data');
title('16x7.5-10 R25B')

%% 
load('TemperatureCompensated_16LC0.mat')

scatter(SA_out,FY_out,'DisplayName','16 LC0 raw data');
title('16x7.5-10 LC0')
