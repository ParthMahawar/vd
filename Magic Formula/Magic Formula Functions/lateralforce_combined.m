function F_y = lateralforce_combined(Xcell,alpha,F_z,p_i,gamma,kappa)
%% Inputs
...
[p_cy1,p_dy1,p_dy2,p_dy3,p_ey1,p_ey2,p_ey3,p_ey4,p_ey5,p_hy1,p_hy2,p_ky1,p_ky2,p_ky3,...
    ...
    r_by3,r_by4,r_cy1,r_ey1,r_ey2,r_hy1,r_hy2,r_vy1,r_vy2,r_vy3,r_vy4,r_vy5,r_vy6] = Xcell{:};

%set r_by3 to 0 for symmetry
%p_ey3 = 0;
%r_by3 = 0;
...
%lambda_muy = 1.025*.55;      % peak friction coefficient
