function dTdt = thermoModel(T,Vx,Vy,Fx,Fy,Fz)
% T: vector of temperatures (C)
% [road, tread, carcass, inflation gas, ambient]

%% Input parameters
V = 25*0.44704; % ground speed (m/s)
P = 10*0.0689; % pressure (bar)
...
R_rt = 0.75; % proportion of heat energy tire receives from frictional power

% conduction with ground-tread
k_21 = 0.9*12e3; % conduction coefficient (W/m^2-K)

w = 0.22; % width of contact patch (m)
...
m_t = 7.38*0.454*0.15; %9.5; % mass of tread (kg)
m_c = 7.38*0.454*0.85; %0.5 % mass of carcass (kg)
