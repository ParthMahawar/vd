function F_x = longitudinalforce_combined_only(Xcell, kappa, F_z, p_i, gamma, alpha)
%%  Inputs
...
[p_cx1,p_dx1,p_dx2,p_dx3,p_ex1,p_ex2,p_ex3,p_ex4,p_hx1,p_hx2,p_kx1,p_kx2,p_kx3,p_px1,...
    p_px2,p_px3,p_px4,p_vx1,p_vx2] = Xcell_Fx{:};

[r_bx1,r_bx2,r_bx4,r_cx1,r_ex1,r_ex2,r_hx1] = Xcell{:};

%set r_hx1 = 0 for symmetry in slip angle
