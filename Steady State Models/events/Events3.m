    ...
    methods
        ...
        function [long_vel_final,long_accel_final,lat_accel_final,time_final] = Track_Solver(obj,arclength,curvature)
            ...
            for j = 1:numel(extrema_indices) % loop through each segment
                ...
                current_gear = sum(long_vel>obj.car.powertrain.switch_gear_velocities)+1;
                ...
                for i = extrema_indices(j):-1:last_index_2 % opposite direction from accel                    
                    ...
                    switch_gear_velocities = [0 obj.car.powertrain.switch_gear_velocities];
                    if long_vel<switch_gear_velocities(current_gear)
                        start_shifting = true;
                    end
                    ...
                    if start_shifting ...
                            && shift_time_cumulative < obj.car.powertrain.shift_time
                        long_accel = -obj.car.aero.drag(long_vel)/obj.car.M;
                        shift_time_cumulative = shift_time_cumulative+time_2(i+1);
                    else
